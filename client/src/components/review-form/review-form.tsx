...
function ReviewForm({ onAddReview, isSubmitting = false }: ReviewFormProps): JSX.Element {
      ...
      >
        ...
        <div className="reviews__button-wrapper">
          ...
          <button
            ...
            type="submit"
            disabled={!isValid || isSubmitting} // ИЗМЕНЕНО
          >
            {isSubmitting ? 'Submitting...' : 'Submit'} {/* ИЗМЕНЕНО */}
          </button>
        </div>
      </form>
    </>
